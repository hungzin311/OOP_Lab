...
public class Equation{
    public static void main(String[] args) {
        ...
        stra = Strnum1 = JOptionPane.showInputDialog(null, "Please Input a", "Second order equation with one variable", JOptionPane.INFORMATION_MESSAGE);
        double a = Double.parseDouble(stra);
        strb = Strnum1 = JOptionPane.showInputDialog(null, "Please Input b", "Second order equation with one variable", JOptionPane.INFORMATION_MESSAGE);
        double b = Double.parseDouble(strb);
        strc = Strnum1 = JOptionPane.showInputDialog(null, "Please Input c", "Second order equation with one variable", JOptionPane.INFORMATION_MESSAGE);
